...
Both endpoints accept a query and return ranked evidence records. Use semantic mode for vector search, grep mode for keyword and boolean prepared-text search, and regex mode for regular expression search.
