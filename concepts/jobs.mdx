...
These limits are enforced when you register files, before any new bytes are transferred. Requests that would exceed either limit are rejected with a 4xx error.
