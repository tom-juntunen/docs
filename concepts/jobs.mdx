...
| `progress` | object | Processed page count, total pages, percent, phase, message, and update timestamp |
| `failedPageCount` | number | Pages that failed or have not completed successfully |
