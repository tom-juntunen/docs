---
title: "Get Started with the Plangrep API in Minutes"
sidebarTitle: "Quickstart"
description: "Learn how to create a project, upload a file, and retrieve normalized JSON results from the Plangrep API in four steps."
---
...
Continue polling until `job.status` is one of: `completed`, `completed_with_errors`, `failed`, or `cancelled`.
