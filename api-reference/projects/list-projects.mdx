...
description: "GET /api/open/v1/projects — returns all API projects for your organization, including each project's status, runtime health, and creation timestamps."
---
