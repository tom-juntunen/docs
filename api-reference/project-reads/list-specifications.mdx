...
description: "GET /api/open/v1/projects/{projectId}/specifications — paginated list of extracted specification sections with filtering by section number and page range."
---
