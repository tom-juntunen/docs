...
<ParamField query="pageStart" type="integer">
  Filter to sections whose content starts on this exact 1-based page number. Minimum: `1`.
</ParamField>

<ParamField query="pageEnd" type="integer">
  Filter to sections whose content ends on this exact 1-based page number. Minimum: `1`.
</ParamField>
