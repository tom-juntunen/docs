...
description: "GET /api/open/v1/projects/{projectId}/regions — paginated list of extracted drawing regions with filtering by region type, drawing type, layout, and more."
---
  ...
  "regions": [
    {
      ...
      "artifacts": [
        { "artifactType": "region_crop", "url": "https://..." }
      ]
    }
  ]
}
