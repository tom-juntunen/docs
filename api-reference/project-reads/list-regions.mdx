...
<ResponseField name="regions" type="ProjectRegionEntity[]">
  ...
  <Expandable title="ProjectRegionEntity fields">
    ...
    <ResponseField name="visual" type="object | null">
      Public visual representation of the region, when available. Includes `kind`, `url`, and `contentType`.
    </ResponseField>
  ...
  "regions": [
    {
      ...
      "visual": { "kind": "sheet_pdf_region", "url": "https://...", "contentType": "application/pdf" }
    }
  ]
}
```
