...
```json
{
  "doc": {
    ...
    "status": "complete",
    "artifacts": [
      { "type": "doc_markdown", "contentType": "text/markdown", "url": "https://...", "readWith": "plangrep_show_artifact_file" },
      { "type": "doc_pdf", "contentType": "application/pdf", "url": "https://...", "readWith": "plangrep_show_artifact_file" },
