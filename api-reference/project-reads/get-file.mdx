---
title: "Get One Extracted File from a Project"
sidebarTitle: "Get File"
description: "GET /api/open/v1/projects/{projectId}/files/{fileId} — retrieves a single extracted file entity with artifacts and metadata."
---
