...
<ParamField query="classification" type="string">
  Filter by analyzed file classification. One of: `plans`, `specifications`, `documents`, `mixed`.
</ParamField>
...
<ResponseField name="files" type="ProjectFileEntity[]">
  ...
  <Expandable title="ProjectFileEntity fields">
    ...
    <ResponseField name="classification" type="string | null">
      Analyzed file classification: `plans`, `specifications`, `documents`, or `mixed`. This is `null` while analysis is pending.
    </ResponseField>
...
```json
{
  ...
  "files": [
    ...
    "artifacts": [
      ...
      { "type": "source_file", "contentType": "application/pdf", "url": "https://...", "readWith": "plangrep_show_artifact_file" }
    ]
    }
  ]
}
