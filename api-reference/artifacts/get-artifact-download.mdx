---
title: "Stream an Artifact Using a One-Time Download Token"
sidebarTitle: "Download Artifact"
description: "GET /api/open/v1/artifact-downloads/:token — streams artifact bytes via a one-time token. Unauthenticated route; token is consumed on a successful GET."
---
